#created by Zoroxyyy aka Sachin Don
...
def ZOROX1():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			...
			if ZOROXfire =='1':yaari.submit(mbasic,uid,pwx,tl)
			elif ZOROXfire =='2':yaari.submit(p,uid,pwx,tl)
			elif ZOROXfire =='3':yaari.submit(x,uid,pwx,tl)
			elif ZOROXfire =='4':yaari.submit(mobile,uid,pwx,tl)
			elif ZOROXfire =='5':yaari.submit(freeq,uid,pwx,tl)
			elif ZOROXfire =='6':yaari.submit(d,uid,pwx,tl)
			else:
...
def ZOROX5():
	...
	with ThreadPool(max_workers=50) as manshera:
		...
		for love in user:
			...
			for Eman in HamiiID:
				pwx.append(Eman)
			if ZOROXfire =='1':manshera.submit(mbasic,uid,pwx,tl)
			elif ZOROXfire =='2':manshera.submit(p,uid,pwx,tl)
			elif ZOROXfire =='3':manshera.submit(x,uid,pwx,tl)
			elif ZOROXfire =='4':manshera.submit(mobile,uid,pwx,tl)
			elif ZOROXfire =='5':manshera.submit(freeq,uid,pwx,tl)
			elif ZOROXfire =='6':manshera.submit(d,uid,pwx,tl)
			else:
